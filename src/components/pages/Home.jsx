    ...
    return (
        ...
        >
            <div className="max-w-screen-sm mx-auto flex flex-col items-center justify-center text-center pt-10 px-4 py-2 md:flex-col tracking-widest">
                <div>
                        <h1 className="subtitle sm:text-6xl font-bold text-orange-300 mt-3">Welcome!</h1>
                        <h2 className="subtitle sm:text-3xl font-bold text-stone-100 mt-3 mb-3">I am a Full Stack Web Developer</h2>
