    ...
    return (
        ...
        >
            <div className="md:max-w-screen-xl mx-auto flex flex-col items-center justify-center text-center pt-10 tracking-widest">
                <div>
                    <h1 className="subtitle md:text-4xl sm:text-5xl font-bold text-orange-400 mt-3">Welcome!</h1>
                    <h2 className="subtitle sm:text-2xl font-bold text-stone-100 mt-3 mb-3">I am a Full Stack Web Developer</h2>
                    <p className="text-xl text-stone-100 sm:text-2xl mb-5">
                    ...
                    <div className="subtitle mb-5 sm:text-4xl font-bold tracking-widest text-orange-400 animate-pulse space-x-4">
